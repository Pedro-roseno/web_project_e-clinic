...
const MenuLayout = () => (
  <div>
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', marginBottom: '1rem', width: '60%' }}>
        <img src="/robot.png"  
        style={{ 
            marginRight: '0.5rem',
            width: '60px',
        ...
        >
         Gostaria de iniciar um atendimento ou acessar o sistema?  
        Para pacientes: Para iniciar o atendimento, por favor, informe o seu CPF.
